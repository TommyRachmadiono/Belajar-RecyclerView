...
public class ListPresidentAdapter extends RecyclerView.Adapter<ListPresidentAdapter.CategoryViewHolder>{
    ...
    public void onBindViewHolder(CategoryViewHolder holder, final int position) {
        ImageView img = holder.itemView.findViewById(R.id.img_item_photo);
        img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(context,"Kamu memilih "+listPresident.get(position).getName(),Toast.LENGTH_SHORT).show();
            }
        });
